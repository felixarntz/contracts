...
* [open an issue](https://github.com/felixarntz/contracts/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/contracts/compare) to the `master` branch
